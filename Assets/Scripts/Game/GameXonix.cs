...
namespace Assets.Scripts.Game
{
    class GameXonix
    {
        ...
        const int COLOR_LAND = 0x316f4a;//0x00a8a8;
        ...
        public static Color GetColor(int color)
        {
            switch (color)
            {
                ...
                case COLOR_WATER: return new Color32(217, 217, 217, 255);
                case COLOR_LAND: return new Color32(49, 111, 74, 255);
        ...
        class Field
        {
            ...
            {
                return Mathf.RoundToInt(_scoreCount);
            }
        }
        ...
        internal class Xonix
        {
            ...
            public void Move()
            {
                if (_direction == LEFT) _y++;
                if (_direction == RIGHT) _y--;
                if (_direction == UP) _x--;
                if (_direction == DOWN) _x++;
        ...
        internal class GameOverAndPause
        {
            ...
            public void OnGameOver()
            {
                if (xonix.GetLivesCount() == 0)
                {
                    Database.instance.AddNewScoreDatabase(field.GetScorePlayer());
        ...
        class Canvas
        {
            public void Paint()
            {
                ...
                GameController.Instance.SetScoreNum(field.GetScorePlayer());
                xonix.Paint();
                balls.Paint();
                cubes.Paint();
